...
<?php $component->withAttributes([]); ?>
    ...
    <body>
            ...
            <div class="animes">
                ...
                <select name="post[anime_id]" id="selectAnime">
                    <?php $__currentLoopData = $animes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $anime): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($anime->id); ?>"><?php echo e($anime->value); ?></option>
        ...
        <script>
            ...
            const animes = <?php echo json_encode($animes, 15, 512) ?>;
            console.log(animes);
...
<?php endif; ?>
</html><?php /**PATH /home/ec2-user/environment/blog/resources/views/posts/create.blade.php ENDPATH**/ ?>